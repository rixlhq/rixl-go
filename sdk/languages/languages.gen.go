...
type ClientInterface interface {
	// ListLanguages makes a GET request to /media/v1/languages
...
// NewListLanguagesRequest creates a GET request for /media/v1/languages
func NewListLanguagesRequest(server string) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/media/v1/languages")
	if operationPath[0] == '/' {
...
// ListLanguages makes a GET request to /media/v1/languages and returns the parsed response.
// ListLanguages
// On success, returns the response body. On HTTP error, returns *ClientHttpError[struct{}].
func (c *SimpleClient) ListLanguages(ctx context.Context, reqEditors ...RequestEditorFn) (models.VideosV1ListLanguagesResponse, error) {
	var result models.VideosV1ListLanguagesResponse
